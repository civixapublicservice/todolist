    ...
    >
      ...
      >
        <defs>
          ...
          <linearGradient id="gear-chrome" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          {/* Rim bevel gradient */}
          <linearGradient id="gear-rim" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%"   stopColor="#b0b8c8" />
            <stop offset="100%" stopColor="#50565e" />
          </linearGradient>

          {/* Inner hole gradient */}
          <radialGradient id="gear-hole" cx="40%" cy="35%" r="65%">
        ...
        <g filter="url(#gear-drop)">
          {/* Base circle */}
          <circle cx="60" cy="60" r="38" fill="url(#gear-chrome)" />
        ...
        <circle cx="60" cy="60" r="38" fill="url(#gear-gloss)" />
        {Array.from({ length: 8 }).map((_, i) => {
          const angle = (i * 45) * Math.PI / 180
          const cx = 60 + Math.cos(angle) * 38
          const cy = 60 + Math.sin(angle) * 38
        ...
        {/* Inner hole rim */}
        <circle cx="60" cy="60" r="20" fill="url(#gear-hole-rim)" />

        {/* Inner hole */}
        <circle cx="60" cy="60" r="17" fill="url(#gear-hole)" />
